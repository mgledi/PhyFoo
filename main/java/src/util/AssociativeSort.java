 ...
 * 
 * <b>Note</b> that this class has been generated automatically using the AssociativeSortClassGenerator class.
 * Do never change the source code in this class because changes could be overwritten by the genrating class. Change the
 * source code of the AssociativeSortClassGenerator class instead.
 * 
 * @author m.gleditzsch
 * @author m.roeder
 */
public class AssociativeSort {
    ...
    /**
     * Partitions part of an array of bytes. <br />
     ...
     */
    private static  void insertionSort(byte[] A, boolean[] Assoc, int left, int right) {
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(byte[] A, byte[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            byte temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(byte[] A, char[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            char temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(byte[] A, short[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            short temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(byte[] A, int[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            int temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(byte[] A, long[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            long temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(byte[] A, float[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            float temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(byte[] A, double[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            double temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static <T> void insertionSort(byte[] A, T[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            byte tmp = A[p];
            T temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, boolean[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            boolean temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, byte[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            byte temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, char[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            char temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, short[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            short temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, int[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            int temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, long[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            long temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, float[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            float temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(char[] A, double[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            double temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static <T> void insertionSort(char[] A, T[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            char tmp = A[p];
            T temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, boolean[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            boolean temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, byte[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            byte temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, char[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            char temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, short[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            short temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, int[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            int temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, long[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            long temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, float[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            float temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(short[] A, double[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            double temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static <T> void insertionSort(short[] A, T[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            short tmp = A[p];
            T temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, boolean[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            boolean temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, byte[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            byte temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, char[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            char temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, short[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            short temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, int[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            int temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, long[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            long temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, float[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            float temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(int[] A, double[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            double temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static <T> void insertionSort(int[] A, T[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            int tmp = A[p];
            T temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, boolean[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            boolean temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, byte[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            byte temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, char[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            char temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, short[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            short temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, int[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            int temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, long[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            long temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, float[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            float temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(long[] A, double[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            double temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static <T> void insertionSort(long[] A, T[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            long tmp = A[p];
            T temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, boolean[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            boolean temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, byte[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            byte temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, char[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            char temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, short[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            short temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, int[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            int temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, long[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            long temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, float[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            float temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(float[] A, double[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            double temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static <T> void insertionSort(float[] A, T[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            float tmp = A[p];
            T temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, boolean[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            boolean temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, byte[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            byte temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, char[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            char temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, short[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            short temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, int[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            int temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, long[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            long temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, float[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            float temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static  void insertionSort(double[] A, double[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            double temp = Assoc[p];
            int j;
     ...
     *            the right-most index of the subarray.
     */
    private static <T> void insertionSort(double[] A, T[] Assoc, int left, int right) {
        for (int p = left + 1; p <= right; p++) {
            double tmp = A[p];
            T temp = Assoc[p];
            int j;
